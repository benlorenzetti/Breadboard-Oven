...
the heat capacity of the bulk air varies with temperature because of the
changes in density and thus quantity of molecules in the chamber.
Unfortunately, SPICE does not have a primitive circuit element for
a variable capacitor. We must build a subcircuit that behaves according to
\begin{equation*}
