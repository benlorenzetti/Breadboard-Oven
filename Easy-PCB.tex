...
\begin{table}
	...
	\begin{tabular}{c c c}
		...
		\hline
		270 ft, 0.036" $\emptyset$ nichrome wire	&120 VAC	&2.5 A	\\
...
it when on. If a fault occured at the half way point, as much as 6 Amps could
...
switch close to the outlet and the relay actuating the nichrome wire will
