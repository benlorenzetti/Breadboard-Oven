...
over the range $20-300^{o}C$. However, the density/mass of air
...
\begin{equation*}
PV=\frac{m}{M}RT\quad\Rightarrow m(T)=\frac{MPV}{R}T
\end{equation*}
...
and there will likely be small leaks that keep the chamber
pressure in equilibrium with atmospheric pressure, $1\,\textrm{atm}$.
