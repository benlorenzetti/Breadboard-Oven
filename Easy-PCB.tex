...
\hline
	...
	&5	&R10--13,21	&pullup resistors	&$10\,k\Omega$		&
	&			&			&		&		\\

	&1	&R16	&thermocouple $R_{f1}$	&see eq. \ref{thermocouple-feedback-ratios-eq} ($100\,\Omega$)	&
	&			&			&		&		\\

	&1	&R18	&thermistor $R_{f2}$	&see eq. \ref{thermistor-feedback-ratio-eq} ($1.7\,k\Omega$)	&
	&			&			&		&		\\

	&1	&R19	&$V_{ref-}$ voltage divider $R_{3}$	&see eq. \ref{vref-resistors-eq} ($6.1\,k\Omega$)	&
	&			&			&		&		\\

	&1	&R23	&relay bias network		&see eq. \ref{heat-relay-bias-network-eq} ($333\,\Omega$)	&
	&			&			&		&		\\
	...
	&2	&R26,28	&Motor Driver	&see eq. \ref{Rbias12-eq} ($140\,\Omega$)	&
	&			&			&		&		\\

	&2	&R27,29	&Motor Driver	&see eq. \ref{Rbias12-eq} ($115\,\Omega$)	&
	&			&			&		&		\\

	&2	&R30,31	&Motor Driver	&see eq. \ref{Rbias34-eq} ($64\,\Omega$)	&
	&			&			&		&		\\

	&4	&R32--35	&Motor Driver	&see eq. \ref{Rcs-eq} ($165\,\Omega$, $P\geq 0.6W$)	&
	&Yageo			&RSF100JB-73-160R	&0.25		&1.00		\\

	&1	&R36	&Motor Driver		&see eq. \ref{Rref-eq} ($51\,\Omega$)
	&			&			&		&		\\

	&3	&R37--39	&Motor Driver	&$10\Omega$		&
	&			&			&		&		\\

	&8	&R40--47	&analog modeling	&TBD			&
	&			&			&		&		\\
...
13	&2	&J3,	&front PCB to controller PCB	&20 pos			&1mm pitch, 1 row flat flex
	...
	&1	&P4	&Screw Terminal Block		&3 pos., > 120 VAC \& 5A	&12--22 AWG, w/ 6--32 screws
