...
so the heating elements, oven frame, and control system are all
optimized for typical solder reflow profile.

\begin{center}
	\includegraphics[width=\columnwidth]{Figures/control-system.pdf}
	\captionof*{figure}{The \emph{Easy--PCB} Control System}
\end{center}
...
\begin{figure*}
	...
	\caption{\emph{Easy--PCB} Control System with Functional Components}
...
\subsection{Thermocouple Selection}
...
To scale $10.2\,mV$ to $3.3\,V$ and $0\,V$ to $0\,V$, the feedback resistors
should be
\begin{equation*}
	\frac{R_{f2}}{R_{f1}}=
...
Similarly, the feedback resistor ratio for type--J thermocouples should be
\begin{equation}
...
\subsection{Relay Selection \& Circuit}
...
As of today, the following features are implemented on
our demo breadboard:
\begin{enumerate}
\item LED display
...
\hyperref[controller-pcb-photo]{figure \ref{controller-pcb-photo}}.

\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{Figures/controller-pcb-photo}
	\caption{Implementation Photo--as of 12/7}
	\label{controller-pcb-photo}
\end{figure}
...
\begin{figure*}
	\centering
	\includegraphics[width=1\textwidth]{Figures/user-interface-flowchart-1.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{Figures/user-interface-flowchart.pdf}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.75\textwidth]{Figures/user-interface-flowchart-2.pdf}
...
\begin{figure*}
	\centering
	\includegraphics[width=0.75\textwidth]{Figures/user-interface-flowchart-3.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=\columnwidth]{Figures/user-interface-flowchart-4.pdf}
